...
const Productdatials = ({ product }) => {
  ...
  const setImgPreview = (url) => {
    console.log(url)
    imgRef.current.src = `http://res.cloudinary.com/shopitnow-udemy/image/upload/v1674393848/${url}.jpg`;
  };
              ...
              <div className="space-x-2 overflow-auto text-center whitespace-nowrap">
                {product?.images?.map((img) => (
                  <a
                    ...
                    onClick={() => setImgPreview(img.public_id)}
                  >
                    <img
                      className="w-14 h-14"
                      src={`http://res.cloudinary.com/shopitnow-udemy/image/upload/v1674393848/${img.public_id}.jpg`}
                      alt="Product title"
                      width="500"
                      height="500"
                    />
